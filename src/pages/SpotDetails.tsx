...
export default function SpotDetails() {
  ...
  const [favorite, setFavorite] = useState(id ? isFavorite(id) : false)
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex items-center gap-6">
                          <div className="text-center">
                            ...
                            <div className="text-sm font-semibold">{day.waveHeight}m</div>
                          </div>
                          <div className="text-center">
                            <Wind className="h-4 w-4 mx-auto mb-1 text-accent" />
                            <div className="text-sm font-semibold">{day.windSpeed}km/h</div>
                          </div>
